...
<body>
    <form id="form1" runat="server">
        ...
        <p>
            <asp:Label ID="lblCustomerDOB" runat="server" Text="Customer D.O.B" width="150px"></asp:Label>
            <asp:TextBox ID="txtCustomerDOB" runat="server"></asp:TextBox>
        </p>
        <p>
            <asp:Label ID="lblCustomerEmailAddress" runat="server" Text="Customer Email Address" width="150px"></asp:Label>
            <asp:TextBox ID="txtCustomerEmailAddress" runat="server"></asp:TextBox>
        </p>
        <p>
            <asp:Label ID="lblCustomerAddress" runat="server" Text="Customer Address" width="150px"></asp:Label>
